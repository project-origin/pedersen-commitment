...
public partial record RangeProof
{
    ...
    {
        [LibraryImport(Library.Name, EntryPoint = "rangeproof_prove_single")]
        ...
        [LibraryImport(Library.Name, EntryPoint = "rangeproof_prove_multiple")]
        ...
        [LibraryImport(Library.Name, EntryPoint = "rangeproof_verify_single")]
        ...
        [LibraryImport(Library.Name, EntryPoint = "rangeproof_verify_multiple")]
        [return: MarshalAs(UnmanagedType.U1)]
        ...
        [LibraryImport(Library.Name, EntryPoint = "rangeproof_free")]
        internal static partial void Free(IntPtr self);

        [LibraryImport(Library.Name, EntryPoint = "rangeproof_to_bytes")]
        internal static partial Extensions.RawVec ToBytes(IntPtr self);

        [LibraryImport(Library.Name, EntryPoint = "rangeproof_from_bytes")]
...
public partial record BulletProofGen
{
    ...
    [LibraryImport(Library.Name, EntryPoint = "bpgen_new")]
    private static partial IntPtr New(uint gensCapacity, uint partyCapacity);

    [LibraryImport(Library.Name, EntryPoint = "bpgen_free")]
